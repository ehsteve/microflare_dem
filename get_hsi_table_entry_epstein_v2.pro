...
; 
;                                                                                       
pro get_hsi_table_entry_epstein, params,model_count_flux,real_count_flux,axis,summary, obj=obj,spec_file=spec_file, drm_file=drm_file, $
fit_time=fit_time,bkg_time=bkg_time                                                                                             
if not is_class(obj,'SPEX',/quiet) then obj = ospex();/no_gui)                                     
;obj-> set, $                                                                              
 ;spex_specfile= 'hsi_spectrum_20110621_175120_d4.fits'    
 obj-> set, $                                                                                                                       
 spex_specfile= spec_file  ;'/home/ainglis/physics/steven_code/hsi_flare_20110621_182202/hsi_spectrum_20110621_175120_d1.fits'
obj-> set, spex_drmfile= drm_file;'hsi_srm_20110621_175120_d1.fits'
obj-> set, spex_source_angle= 23.8350                                                     
obj-> set, spex_source_xy= [284.317, 263.935]                                             
obj-> set, spex_erange= [4.0000000D, 12.000000D]                                          
obj-> set, spex_fit_time_interval= fit_time ;['21-Jun-2011 18:22:00.000', $                         
; '21-Jun-2011 18:23:00.000']   
obj-> set, spex_bk_time_interval= bkg_time ;['21-Jun-2011 18:36:00.000', '21-Jun-2011 18:39:00.000']                                                           
...
obj-> set, spex_tband= fit_time; ['21-Jun-2011 18:22:00.000', '21-Jun-2011 18:23:00.000']  
