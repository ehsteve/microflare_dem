PRO aia_hsi_dem_analysis_manual, DIR = dir, HSI_IMAGE = hsi_image, FILESET = fileset, FORCE_TABLE = force_table, aia_only=aia_only
...
;flux_obs = reform(images[i,j,*])
		...
		FOR k=15, 15 DO BEGIN
   			FOR l = 18, 18 DO BEGIN
				flux_dem1 = reform(flux[k,l,*])
				em1	= 1.106e22  ;total(flux_obs)/total(flux_dem1) 
