PRO aia_hsi_dem_analysis_bksub, DIR = dir, HSI_IMAGE = hsi_image, FILESET = fileset, FORCE_TABLE = force_table
...
file_bk_iw = reform(file_list(marker-70,*))
...
aia_hsi_fit_results=create_struct('chi_2d',chi2d,'chi2d_hsi',chi2d_hsi,'axis',axis,'em_2d',em_2d,'em_2d_hsi',em_2d_hsi,$
...
SAVE,aia_hsi_fit_results,filename='aia_hsi_fit_results_bksub.sav',/verbose
